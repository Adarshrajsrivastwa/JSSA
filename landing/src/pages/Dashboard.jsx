...
//           .notice-text      { font-size: 8px !important; font-weight: 400 !important; line-height: 1.9 !important; margin-bottom: 14px !important; }
    ...
    <>
      ...
      >
        <div className="public-notice-inner">
          ...
          <p
            className="body-text"
            style={{ margin: "0 0 12px 0", lineHeight: 1.9, color: "#555" }}
          >
            ...
            सिर्फ हमारे वेबसाइट के माध्यम से ऑनलाइन लिया जाता है) अगर इसके अलावा
