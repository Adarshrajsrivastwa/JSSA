...
export default function AboutPage() {
  return (
    ...
    >
      <div
        style={{ maxWidth: 1400, margin: "0 auto", padding: "40px 100px" }}
        className="about-inner"
      >
        {/* MAIN TITLE */}
        <div style={{ textAlign: "center", marginBottom: 32 }}>
        ...
        >
          Jan Swasthya Sahayata Abhiyan is a social welfare project of
          Nirmanbharat Assistance Council aimed at supporting people with
          health-related assistance and awareness. The initiative works to
          connect beneficiaries with essential healthcare support and resources.
        </div>
